                ...
                <div class="mainCard left-card">
                    ...
                    <div class="personal_details">
                        ...
                        <div>
                            ...
                            <input class="input-default" type="text" placeholder="First Name" />
                            <input class="input-default" type="text" placeholder="First Name" />
                        </div>
                        <div>
                            <label>Last Name</label>
                            <input class="input-default" type="text" placeholder="Last Name" />
                            <input class="input-default" type="text" placeholder="Last Name" />
                        </div>
                        <div>
                            <label>Email</label>
                        ...
                        <div>
                            ...
                            <input class="input-default" type="text" placeholder="Residence" />
                            <input class="input-default" type="text" placeholder="Residence" />
                        </div>
